...
Les palettes de couleur OFCE peuvent être directement chargées depuis le package à l'aide de la commande `load`. Trois palettes sont actuellement enregistrées :
