...
> **Règle 4** : Il faut utiliser au moins Quarto 1.5 ([la version actuelle est 1.5.57](https://quarto.org/docs/download/)). Il y a des mises à jour fréquentes, qui sont nécessaires et qui apportent de nombreuses corrections ou des fonctionnalités importantes.
