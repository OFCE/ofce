...
- [`girafy()`](https://ofce.github.io/ofce/reference/girafy.md) peut
  maintenant générer des graphiques qui n’ont pas le même aspect ratio
  sur mobile et desktop.

## OFCE 1.3.35

- ajout dans
  [`get_icons()`](https://ofce.github.io/ofce/reference/get_icons.md) et
  `get_flags` d’options pour sortir du md et des icones en png

## OFCE 1.3.34

- ajout de
  [`get_icons()`](https://ofce.github.io/ofce/reference/get_icons.md) et
  `get_flags` pour obtenir des svg d’emojis et drapeaux, et faciliter
  leur intégration dans les tooltips

## OFCE 1.3.33

- ajout de
  [`licence_auteur()`](https://ofce.github.io/ofce/reference/licence_auteur.md)
  pour placer la licence CC-by , l’auteur et le logo ofce sur les
  graphiques
...
- [`scale_color_pays()`](https://ofce.github.io/ofce/reference/scale_color_pays.md)
  prend un argument `values` pour mettre des exceptions (un pays dont la
  couleur n’est pas celle de la palette)

## OFCE 1.3.30

- [`licence_auteur()`](https://ofce.github.io/ofce/reference/licence_auteur.md)
  ajoute sur la droite du graphique un grob avec la licence CC by 4.0 ,
  l’auteur, l’annee et le logo OFCE

## OFCE 1.3.29

- [`save_object()`](https://ofce.github.io/ofce/reference/save_object.md)
  et `load_object` généralisent la fonction de sauvegarde des graphes et
  marche pour les tableaux.
