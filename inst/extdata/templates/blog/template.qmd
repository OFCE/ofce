...
---
 ...
 <!-- Lien vers le billet de blog en format pdf. A compiler  avant avec la version finale du .qmd et en format blog-pdf puis à insérer dans le dossier du billet (attention à bien renommer le nom du fichier) -->

::: {.content-visible when-format="html"}
[{{< fa file-pdf size=2xl >}}](nomdufichier.pdf)
:::
...
```{r}
#| label: tab-cars
#| tab-cap: Speed versus distance among cars
#| echo : false
#| message : false

library(gt)

gt.cars <- cars |> mutate(names = str_c("name_",row_number())) |>
  select(names, speed, dist) |> gt()

theme.gt_ofce(gt.cars)
```
