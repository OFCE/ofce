...
format:
  blog-html: default
  blog-pdf: default
categories: ["keyword1", "keyword2"] # A choisir parmi une liste prédéterminée (ofce::keywords_list() pour y avoir accès)
image: image.jpg


## A activer pour permettre les commentaires via hypothesis (activer son profil via https://hypothes.is/groups/9A3bza7D/blog et s'inscrire au groupe blog)
