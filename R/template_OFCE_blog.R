#' template_OFCE_blog
#'
#' charge un mod\\U+00E8le de document quarto pour un billet de blog
#'
...
template_OFCE_blog <- function(file_name = NULL) {
  ext_name <- "blog"
  ...
  stopifnot("Le nom du template est incorrect, veuillez en choisir un parmi la liste suivante: c(\"quartotemplate\", \"WorkingPaper\", \"blog\") " = ext_name %in% c("quartotemplate", "WorkingPaper", "blog"))
