...
#
g_IC_DR_2<- ggplot(data, aes(x=period, y=value, col = name)) +
  # geom_line(key_glyph="timeseries")+ # option 1
  geom_textline(aes(label=name), size = 2.5, padding=unit(1, "mm"), linewidth=0.5, text_smoothing = 30, show.legend = FALSE)+
