...
octobre 2025}};
      \node [anchor = east] at (8.5,-12){\textcolor{black}{Modifié le : 21
novembre 2025}};
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title={Encadré \ref*{tip-e1}: les encadrés doivent fonctionner}, bottomtitle=1mm, breakable, colback=white, rightrule=.15mm, toptitle=1mm, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, titlerule=0mm, toprule=.15mm, left=2mm, coltitle=black, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame]
